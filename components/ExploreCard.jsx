...
const ExploreCard = ({id, imgUrl, title, index, active, handleClick}) => (
	<motion.div
		...
		className={
			`relative flex items-center justify-center min-w-[170px] h-[700px] transition-[flex] duration-[0.7] ease-out-flex cursor-pointer
                ${active === id
		? 'lg:flex-[3.5] flex-[10]'
		: 'lg:flex-[0.5] flex-[2]'}`}
	...
	>
		...
		{active === id ? (
			<div
				...
				<div
					className='flexCenter w-[60px] h-[60px] rounded-[24px] mb-[16px] glassmorphism '>
					<img
						src='/headset.svg'
						alt='headset'
